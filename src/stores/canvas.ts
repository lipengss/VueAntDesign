...
export const useCanvasStore = defineStore('canvasStore', {
  ...
  getters: {
    ...
    canvasStyle(state) {
      const { canvasWidth, canvasHeight, backgroundColor, isShowBackgroundImage, backgroundImage, backgroundSize, backgroundPosition, backgroundRepeat } = state.canvasOption
