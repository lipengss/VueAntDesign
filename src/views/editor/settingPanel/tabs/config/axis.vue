	...
	<div class="axis">
		...
		<a-collapse v-model="activeKeys" expandIconPosition="right" @change="collapseChange">
			<a-collapse-panel key="guide" :disabled="!axis.axisLine.show">
				<template v-slot:header> <a-switch :size="size" v-model:checked="axis.axisLine.show" @change="switchChange('guide')" /> 辅助线 </template>
				<a-row :gutter="[10, 10]">
					<a-col :span="7">颜色</a-col>
					<a-col :span="17">
					...
					<a-col :span="17">
						<a-select :size="size" v-model:value="axis.axisLine.lineStyle.type" style="width: 100%">
			...
			<a-collapse-panel key="split" :disabled="!axis.splitLine.show">
				<template v-slot:header> <a-switch :size="size" v-model:checked="axis.splitLine.show" @change="switchChange('split')" /> 分割线 </template>
				<a-row :gutter="[10, 10]">
					<a-col :span="7">颜色</a-col>
					<a-col :span="17">
